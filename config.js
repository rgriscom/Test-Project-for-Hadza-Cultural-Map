var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            image: '',
            image_width: '50%',
            description: "<img id='test_image' src='https://ssl.c.photoshelter.com/img-get/I0000b6HRoGzjkwY/s/850/Evolution-of-Diet-010.jpg' width='55%' style='border:5px solid black;margin:0px 20px 0px 40px'><p><i style='font-size: 20px'>We Hadzabe have no record of famine in our oral history.</i> The reason is that we depend on natural producs of the environment such as berries, tubers, baobab fruits, honey and many wild animals for food. By living in this way, the environment we depend on is not damaged and remains healthy.</p>",
            description_sw: "<img id='test_image' src='https://ssl.c.photoshelter.com/img-get/I0000b6HRoGzjkwY/s/850/Evolution-of-Diet-010.jpg' width='55%' style='border:5px solid black;margin:0px 20px 0px 40px'><p><i style='font-size: 20px'>We Hadzabe have no record of famine in our oral history.</i>We Hadzabe have no record of famine in our oral history. The reason is that we depend on natural producs of the environment such as berries, tubers, baobab fruits, honey and many wild animals for food. By living in this way, the environment we depend on is not damaged and remains healthy.</p>",
            alignment: 'left',
            opacity: 'normal',
            video: 'no',
            sound: 'no',
        ...
        },
        {
            ...
            image: '',
            image_width: '100%',
            description: "<img id='test_image' src='https://www.nalemoru.com/wp-content/uploads/2019/09/NaleMoru-Meet-The-Hadza-People-06.jpg' width='75%' style='border:5px solid black;margin:0px 20px 0px 20px'><p>After he was married but before independence (1950s) Mzee Bode and Maroba's grandfather lived at Mambutu for many months. At that time there were no people, the areas was full of wildlife and the ikanawangupee kenebee paintings of those early people who stood like giraffe were clearly visible",
            description_sw: "<img id='test_image' src='https://www.nalemoru.com/wp-content/uploads/2019/09/NaleMoru-Meet-The-Hadza-People-06.jpg' width='75%' style='border:5px solid black;margin:0px 20px 0px 20px'><p>After he was married but before independence (1950s) Mzee Bode and Maroba's grandfather lived at Mambutu for many months. At that time there were no people, the areas was full of wildlife and the ikanawangupee kenebee paintings of those early people who stood like giraffe were clearly visible",
            alignment: 'left',
            opacity: 'normal',
            video: 'no',
            sound: 'no',
        ...
        },
        {
            ...
            image: '',
            image_width: '100%',
            description: "<img id='test_image' src='https://www.dropbox.com/s/d4s35pkq2r5tih8/2-.png?raw=1' width='75%' style='border:5px solid black;margin:0px 20px 0px 20px'><p>Gudandi, Siagi's mother and elders Shush & Shella used to live in this area now taken over by the Iraqw.",
            description_sw: "<img id='test_image' src='https://www.dropbox.com/s/d4s35pkq2r5tih8/2-.png?raw=1' width='75%' style='border:5px solid black;margin:0px 20px 0px 20px'><p>Gudandi, Siagi's mother and elders Shush & Shella used to live in this area now taken over by the Iraqw.",
            alignment: 'left',
            opacity: 'normal',
            video: 'no',
            sound: 'no',
