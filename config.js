var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            image: '',
            image_width: '100%',
            description: "<img id='test_image' src='https://www.dropbox.com/s/d4s35pkq2r5tih8/2-.png?raw=1' width='25%' align='left' style='border:5px solid black;margin:0px 20px 0px 20px'><p>Gudandi, Siagi's mother and elders Shush & Shella used to live in this area now taken over by the Iraqw.",
            description_sw: "<img id='test_image' src='https://www.dropbox.com/s/d4s35pkq2r5tih8/2-.png?raw=1' width='25%' align='left' style='border:5px solid black;margin:0px 20px 0px 20px'><p>Gudandi, Siagi's mother and elders Shush & Shella used to live in this area now taken over by the Iraqw.",
            alignment: 'left_small',
            opacity: 'normal',
            video: 'no',
            sound: 'no',
        ...
        },
        {
            ...
            image: '',
            image_width: '100%',
            description: '<center><video loop id="myVideo2" width="320" height="240"><source src="https://www.dropbox.com/s/0llwi9me25vvmn4/Hadza%20Foraging%20Compilation.mp4?raw=1" type="video/mp4"></video></center><p>The Hadza forage for honey and roots.</p>',
            description_sw: '<center><video loop id="myVideo2" width="320" height="240"><source src="https://www.dropbox.com/s/0llwi9me25vvmn4/Hadza%20Foraging%20Compilation.mp4?raw=1" type="video/mp4"></video></center><p>The Hadza forage for honey and roots.</p>',
            alignment: 'left_small',
            opacity: 'normal',
            video: 'myVideo2',
            sound: 'no',
