var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            image: '',
            image_width: '50%',
            description: "<center><img id='test_image' src='https://ssl.c.photoshelter.com/img-get/I0000b6HRoGzjkwY/s/850/Evolution-of-Diet-010.jpg' width='55%' style='border:5px solid black;margin:0px 0px 20px 0px'></center><p><i style='font-size: 20px'><center>We Hadzabe have no record of famine in our oral history.</i></center> <p>The reason is that we depend on natural producs of the environment such as berries, tubers, baobab fruits, honey and many wild animals for food. By living in this way, the environment we depend on is not damaged and remains healthy.</p>",
            description_sw: "<center><img id='test_image' src='https://ssl.c.photoshelter.com/img-get/I0000b6HRoGzjkwY/s/850/Evolution-of-Diet-010.jpg' width='55%' style='border:5px solid black;margin:0px 0px 20px 0px'></center><p><i style='font-size: 20px'><center>We Hadzabe have no record of famine in our oral history.</i></center><p>We Hadzabe have no record of famine in our oral history. The reason is that we depend on natural producs of the environment such as berries, tubers, baobab fruits, honey and many wild animals for food. By living in this way, the environment we depend on is not damaged and remains healthy.</p>",
            alignment: 'left',
            opacity: 'normal',
            video: 'no',
            sound: 'no',
