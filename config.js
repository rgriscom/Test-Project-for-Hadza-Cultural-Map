var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            image: '',
            image_width: '50%',
            description: "<audio id='whipporwil'><source src='https://docs.google.com/uc?export=download&id=1D1KPCKjiYqErTMBDWBs730566JD58Kj9' type='audio/wav'></audio><center><img id='test_image' src='https://drive.google.com/uc?export=view&id=1fsfbvePy4xmiTysj1G482joqtebszO9N' width='55%' style='border:5px solid black;margin:0px 0px 10px 0px'></center><p><i style='font-size: 20px'><center>We Hadzabe have no record of famine in our oral history.</i></center> <p>The reason is that we depend on natural producs of the environment such as berries, tubers, baobab fruits, honey and many wild animals for food. By living in this way, the environment we depend on is not damaged and remains healthy.</p>",
            description_sw: "<audio id='whipporwil'><source src='https://docs.google.com/uc?export=download&id=1D1KPCKjiYqErTMBDWBs730566JD58Kj9' type='audio/wav'></audio><center><img id='test_image' src='https://drive.google.com/uc?export=view&id=1fsfbvePy4xmiTysj1G482joqtebszO9N' width='55%' style='border:5px solid black;margin:0px 0px 10px 0px'></center><p><i style='font-size: 20px'><center>We Hadzabe have no record of famine in our oral history.</i></center><p>We Hadzabe have no record of famine in our oral history. The reason is that we depend on natural producs of the environment such as berries, tubers, baobab fruits, honey and many wild animals for food. By living in this way, the environment we depend on is not damaged and remains healthy.</p>",
            alignment: 'left',
            opacity: 'normal',
            video: 'no',
            sound: 'whipporwil',
        ...
        },
        {
            ...
            image: '',
            image_width: '100%',
            description: "<img id='test_image' src='https://www.dropbox.com/s/d4s35pkq2r5tih8/2-.png?raw=1' width='120px' height='180px' align='left' style='border:5px solid black;margin:0px 20px 0px 20px;paddingL 0px 0px 20px 0px'><p>Gudandi, Siagi's mother and elders Shush & Shella used to live in this area now taken over by the Iraqw.",
            description_sw: "<img id='test_image' src='https://www.dropbox.com/s/d4s35pkq2r5tih8/2-.png?raw=1' width='120px' height='180px' align='left' style='border:5px solid black;margin:0px 20px 0px 20px;padding: 0px 0px 20px 0px'><p>Gudandi, Siagi's mother and elders Shush & Shella used to live in this area now taken over by the Iraqw.",
            alignment: 'left_small',
            opacity: 'normal',
            video: 'no',
            sound: 'no',
        ...
        },
        {
            ...
            title_sw: 'Ramani ya ingiliani',
            image: '',
            image_width: '100%',
            description: 'Click below',
            description_sw: 'Bofya kiungo chini',
            alignment: 'left_small',
            opacity: 'normal',
            video: 'myVideo2',
            sound: 'no',
